...
public class AutomateHighwaySourceryWorker: AutomateHighwaySourceryWorkerProtocol, AutoGenerateProtocol
{
    ...
    ) throws
    {
        ...
        sourceryAutoProtocolFile = try disk.templateFolder().subfolder(named: "Sources/SourceryAutoProtocols").file(named: "SourceryAutoProtocols.swift")
        autoGeneratedCodeFolder = try sourcesFolder.createSubfolderIfNeeded(withName: "/Sources/AutoGeneratedCode")
            ...
            do
            {
                ...
                { target in
                    try Sourcery(
                        ...
                        sourceryYMLFile: try self.sourcesFolder.createFileIfNeeded(named: ".sourcery-\(target.rawValue).yml"),
