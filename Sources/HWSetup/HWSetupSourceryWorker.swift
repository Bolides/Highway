...
public class HWSetupSourceryWorker: HWSetupSourceryWorkerWorkerProtocol, AutoGenerateProtocol
{
    ...
    ) throws
    {
        ...
        do
        {
            ...
            autoGeneratedCodeFolder = try sourcesFolder.createSubfolderIfNeeded(withName: "Generated")
    ...
    public func attempt(_ async: @escaping (@escaping SourceryWorker.SyncOutput) -> Void)
    {
        ...
        { [weak self] in
            ...
            {
                async { throw HighwayError.prematureRelease(in: "\(HWSetupSourceryWorker.self) \(#function) \(#line) could not complete because self was released") }
                return
            }
