...
open class SystemExecutorProtocolMock: SystemExecutorProtocol {
  ...
  public var launchTaskWaitReceivedArguments: (task: (TaskProtocol), wait: (Bool))?

  // MARK: - <launch> - closure mocks

  public var launchTaskWaitClosure: ((TaskProtocol, Bool) throws  -> Void)? = nil



  // MARK: - <launch> - method mocked

  open func launch(task: TaskProtocol, wait: Bool) throws {
...
open class SystemProtocolMock: SystemProtocol {
  ...
  public var executeReceivedTask: TaskProtocol?
  public var executeReturnValue: Bool?

  // MARK: - <execute> - closure mocks

  public var executeClosure: ((TaskProtocol) throws  -> Bool)? = nil



  // MARK: - <execute> - method mocked

  open func execute(_ task: TaskProtocol) throws -> Bool {
  ...
  public var launchWaitReceivedArguments: (task: (TaskProtocol), wait: (Bool))?
  public var launchWaitReturnValue: Bool?

  // MARK: - <launch> - closure mocks

  public var launchWaitClosure: ((TaskProtocol, Bool) throws  -> Bool)? = nil



  // MARK: - <launch> - method mocked

  open func launch(_ task: TaskProtocol, wait: Bool) throws -> Bool {
