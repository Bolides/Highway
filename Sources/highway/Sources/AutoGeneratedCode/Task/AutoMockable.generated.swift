...
open class SystemExecutorProtocolMock: SystemExecutorProtocol
{
    ...
    public var launchTaskWaitClosure: ((Task, Bool) throws -> Void)?
...
open class SystemProtocolMock: SystemProtocol
{
    ...
    public var taskNamedClosure: ((String) throws -> Task)?
    ...
    public var executeClosure: ((Task) throws -> Bool)?
    ...
    public var launchWaitClosure: ((Task, Bool) throws -> Bool)?
