...
public class Parser<O>
{
    ...
    public func add<ValueType>(_ key: Key<ValueType>, binder: @escaping (O, ValueType) -> Void)
    {
        let anyBinder: ((_ object: O, _ value: Any) -> Void) = { object, value in
    ...
    {
        let key: AnyKey
        let binder: (_ object: O, _ value: ValueType) -> Void
    }
}
