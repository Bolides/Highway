...
public class AutomateHighwaySourceryWorker: AutomateHighwaySourceryWorkerProtocol, AutoGenerateProtocol
{
    ...
    ) throws
    {
        ...
        let swiftFormatWorker = try SwiftFormatWorker(forAutogeneratedCode: ProjectFolderWorker.self)

        self.workers = sourcerySequence.map { SourceryWorker(sourcery: $0, swiftFormatWorker: swiftFormatWorker) }
    }
