...
open class HighwayProtocolMock: HighwayProtocol {
  ...
  public var dependencyWithClosure: ((String) throws  -> DependencyProtocol)? = nil
  ...
  public var gitHooksClosure: (() throws  -> FolderProtocol)? = nil
  ...
  public var templateFolderExpectedNameClosure: ((String) throws  -> FolderProtocol)? = nil
  ...
  public static var packageForDependencyServiceDumpServiceTerminalSignPostClosure: ((FolderProtocol, DependencyServiceProtocol, DumpService, TerminalProtocol, SignPostProtocol) throws  -> PackageProtocol)? = nil
...
open class HighwayRunnerProtocolMock: HighwayRunnerProtocol {
  ...
  public var generateDocsForClosure: ((Set<SwiftProduct>, @escaping (@escaping HighwayRunner.SyncDocs) -> Void)  -> Void)? = nil
  ...
  public var runTestsClosure: ((@escaping (@escaping HighwayRunner.SyncTestOutput) -> Void)  -> Void)? = nil
  ...
  public var runSourceryClosure: ((@escaping (@escaping SourceryWorker.SyncOutput) -> Void)  -> Void)? = nil
  ...
  public var addGithooksPrePushClosure: (() throws  -> Void)? = nil
  ...
  public var runSwiftformatClosure: ((@escaping (@escaping HighwayRunner.SyncSwiftformat) -> Void)  -> Void)? = nil
  ...
  public var runSwiftPackageGenerateXcodeProjectClosure: ((@escaping (@escaping HighwayRunner.SyncSwiftPackageGenerateXcodeProj) -> Void)  -> Void)? = nil
  ...
  public var checkIfSecretsShouldBeHiddenInClosure: ((FolderProtocol) throws  -> Void)? = nil
