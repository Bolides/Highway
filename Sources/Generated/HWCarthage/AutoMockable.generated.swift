...
open class CarthageBuilderProtocolMock: CarthageBuilderProtocol {
  ...
  public var attemptBuildCarthageIfNeededClosure: (() throws  -> FileProtocol)? = nil
...
open class HWCarthageProtocolMock: HWCarthageProtocol {
  ...
  public var attemptRunCarthageIfCommandLineOptionAddedInClosure: ((FolderProtocol, @escaping (@escaping HWCarthage.SyncOutput) -> Void)  -> Void)? = nil
