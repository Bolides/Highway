...
open class GitHooksWorkerProtocolMock: GitHooksWorkerProtocol
{
    ...
    public var initSwiftPackageDependenciesSwiftPackageDumpCommandlineOptionsExecutableNamePrePushScriptCommandlineOptionsGitHooksFolderSignPostReceivedArguments: (swiftPackageDependencies: DependencyProtocol, swiftPackageDump: DumpProtocol, commandlineOptions: Set<GitHooksWorker.Option>, executableName: String?, prePushScriptCommandlineOptions: String?, gitHooksFolder: FolderProtocol?, signPost: SignPostProtocol)?

    // MARK: - <init> - closure mocks

    public var initSwiftPackageDependenciesSwiftPackageDumpCommandlineOptionsExecutableNamePrePushScriptCommandlineOptionsGitHooksFolderSignPostClosure: ((DependencyProtocol, DumpProtocol, Set<GitHooksWorker.Option>, String?, String?, FolderProtocol?, SignPostProtocol) -> Void)?

    // MARK: - <init> - initializer mocked

    public required init(swiftPackageDependencies: DependencyProtocol, swiftPackageDump: DumpProtocol, commandlineOptions: Set<GitHooksWorker.Option>, executableName: String?, prePushScriptCommandlineOptions: String?, gitHooksFolder: FolderProtocol?, signPost: SignPostProtocol)
    {
        initSwiftPackageDependenciesSwiftPackageDumpCommandlineOptionsExecutableNamePrePushScriptCommandlineOptionsGitHooksFolderSignPostReceivedArguments = (swiftPackageDependencies: swiftPackageDependencies, swiftPackageDump: swiftPackageDump, commandlineOptions: commandlineOptions, executableName: executableName, prePushScriptCommandlineOptions: prePushScriptCommandlineOptions, gitHooksFolder: gitHooksFolder, signPost: signPost)
        initSwiftPackageDependenciesSwiftPackageDumpCommandlineOptionsExecutableNamePrePushScriptCommandlineOptionsGitHooksFolderSignPostClosure?(swiftPackageDependencies, swiftPackageDump, commandlineOptions, executableName, prePushScriptCommandlineOptions, gitHooksFolder, signPost)
    }
