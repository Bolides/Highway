...
final class HighwaysTests: XCTestCase
{
    ...
    func testDirectDependenciesAreCalled()
    {
        ...
        func _build() throws -> String
        {
            ...
            let result: String = try highway.result(for: .test)
    ...
    func testThrowingEmptyHandler()
    {
        ...
        let errorExpectation = expectation(description: "onEmptyCommand handler is called.")
        highway.onError = { _ in
            errorExpectation.fulfill()
        }

        let emptyExpectation = expectation(description: "onEmptyCommand handler is called.")
        highway.onEmptyCommand = {
